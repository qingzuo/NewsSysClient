...
public class DragGridView extends GridView{
	...
	private boolean isTouchInItem(View dragView, int x, int y){
		...
		if(dragView != null && (x < leftOffset || x > leftOffset + dragView.getWidth())){
			return false;
		}
		
		if(dragView != null && (y < topOffset || y > topOffset + dragView.getHeight())){
			return false;
		}
	...
	private Runnable mScrollRunnable = new Runnable() {
		...
		public void run() {
			...
			//实现GridView的自动滚动 
			smoothScrollToPositionFromTop(mDragPosition, view.getTop() + scrollY); // null
		}
	};
	...
	private void onStopDrag(){
		View v = getChildAt(mDragPosition - getFirstVisiblePosition());
		if (v != null ) {
